...
const AllTask = () => {
    ...
    return (
        <div id='alltask' className='bg-[#1c1c1c] p-5 mt-5 rounded  '>
            <div className=' mb-2 py-3 px-4 flex justify-between rounded'>
                <h2 className='text-lg text-white font-medium  w-1/5 '>Employee Name</h2>
                <h3 className='text-lg text-white font-medium  w-1/5 '>New Task</h3>
                <h5 className='text-lg text-white font-medium  w-1/5 '>Active Task</h5>
                <h5 className='text-lg text-white font-medium  w-1/5 '>Completed</h5>
                <h5 className='text-lg text-white font-medium  w-1/5 '>Failed</h5>
            </div>
            <div className=''>
